...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      <AuthrizedElement roles={['admin']}><button>Realm admin Acction Button</button></AuthrizedElement>

      <hr/>

      <h2>ClientAdmin User Role can access bellow button</h2>
      <small>button goes here</small>
      <AuthrizedElement roles={['user']}><button>Client Admin Acction Button</button></AuthrizedElement>
